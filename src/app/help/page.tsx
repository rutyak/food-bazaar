          ...
          <Accordion allowToggle w="100%">
            <AccordionItem>
              ...
              <AccordionPanel pb={4} color={textColor}>
                To place an order, simply browse our menu, select the items you
                wish to purchase, and click on the 'Add to Cart' button. Once
                you're ready, proceed to checkout and follow the prompts to
                complete your order.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} color={textColor}>
                ...
                PayPal, and Apple Pay. All transactions are secure and
                encrypted.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} color={textColor}>
                ...
                with a tracking link. You can use this link to monitor the
                status and estimated delivery time of your order.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4} color={textColor}>
                ...
                support@foodbazaar.com or call us at (123) 456-7890. Our support
