        ...
        <Container maxW="1200px" px={{ base: 4, md: 8 }}>
          ...
          >
            ...
            <Text
              ...
              maxW="700px"
            >
              Founded in 2023, we've grown from a small kitchen idea into a
              thriving food brand serving customers across the city.
            </Text>
          </VStack>
          ...
          >
            ...
            >
              ...
              <Text
                ...
                lineHeight="relaxed"
              >
                We’re dedicated to giving you the very best meals with a focus
                on quality, customer satisfaction, and uniqueness.
              </Text>
              <Text
                fontSize={{ base: "md", md: "lg" }}
                color="gray.600"
                lineHeight="relaxed"
              >
                We hope you enjoy our meals as much as we enjoy delivering them
                to you. Every dish is prepared with the utmost care and passion.
              </Text>
            </VStack>
          </Flex>
          ...
          >
            <Box
              ...
              borderColor={borderColor}
            >
              <Heading size={{ base: "md", md: "lg" }} color="gray.800" mb={4}>
                Our Vision
              </Heading>
              <Text
                color="gray.600"
            ...
            >
              ...
              <Text
                ...
                lineHeight="relaxed"
              >
                To revolutionize food delivery through quality ingredients,
                prompt service, and continuous innovation for every customer.
              </Text>
            </Box>
          </SimpleGrid>
        </Container>
