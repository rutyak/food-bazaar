    ...
    >
      ...
      >
        ...
        >
          ...
          <Text fontSize="lg" color={textColor}>
            Founded in 2023 by a group of food enthusiasts, FoodBazaar has come
            a long way from its beginnings in a small kitchen. Our passion for
            delicious and convenient meals drove us to turn hard work and
            inspiration into a thriving food brand.
          </Text>
          <Text fontSize="lg" color={textColor}>
            We now serve customers all over the city and are thrilled to be part
            of the fast-paced wing of the food industry. We hope you enjoy our
            meals as much as we enjoy offering them to you.
          </Text>
        </VStack>
      </Flex>
